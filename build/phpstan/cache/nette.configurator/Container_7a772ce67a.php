...
class Container_7a772ce67a extends _PHPStan_5adafcbb8\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0437(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_7a772ce67a $container)
			{
	...
	public function createServiceContainer(): Container_7a772ce67a
	{
		return $this;
	}
